/**
 * OpenAI API integration for SVG generation
 * Uses OpenAI's ChatGPT API to generate SVG code from text prompts
 */
...
export class OpenAIAPI {
  ...
  private readonly MODEL = 'gpt-4o' // GPT-4 Omni (latest model)
...
<svg viewBox="0 0 400 300" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
  ...
  /**
   * Extract SVG code from ChatGPT's response
